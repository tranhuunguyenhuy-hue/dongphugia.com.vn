...
interface SmartFilterNuocProps {
    brands: FilterOption[]
    subtypes: FilterOption[]
    materials?: FilterOption[] // Thêm vật liệu cho ngành nước
}
...
export function SmartFilterNuoc({
    brands,
    subtypes,
    materials,
}: SmartFilterNuocProps) {
    ...
    const activeFilterCount = useMemo(() => {
        ...
        if (activeMaterial) count++
        return count
    }, [activeBrand, activeSubtype, activeMaterial])
