...
interface NuocBrand {
    ...
    slug: string;
    _count?: {
        nuoc_products: number;
    };
}

interface BrandCarouselNuocProps {
    typeName?: string;
    typeSlug?: string;
    brands: NuocBrand[];
    activeSlug?: string;
...
export function BrandCarouselNuoc({ typeName, typeSlug, brands, activeSlug, categoryMode = false }: BrandCarouselNuocProps) {
