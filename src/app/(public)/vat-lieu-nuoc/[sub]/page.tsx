...
export default async function VatLieuNuocSubPage({ params, searchParams }: PageProps) {
    const { sub } = await params
                ...
                <div className="flex-1 w-full min-w-0 pb-16 space-y-8">
                    ...
                    <div>
                        ...
                        <p className="text-sm text-neutral-500">
                            {subcategory.description || 'Vật liệu nước chính hãng · Bảo hành đầy đủ · Tư vấn miễn phí'}
                        </p>
                    </div>
