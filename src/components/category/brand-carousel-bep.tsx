...
interface BepBrand {
    ...
    slug: string;
    _count?: {
        bep_products: number; // changed from tbvs_products
    };
}

interface BrandCarouselBepProps {
    typeName?: string;
    typeSlug?: string;
    brands: BepBrand[];
    activeSlug?: string;
...
export function BrandCarouselBep({ typeName, typeSlug, brands, activeSlug, categoryMode = false }: BrandCarouselBepProps) {
