...
import { SmartFilterNuoc } from "./smart-filter-nuoc"

interface FilterOption { name: string; slug: string }

interface FilterDrawerNuocProps {
    brands: FilterOption[]
...
export function FilterDrawerNuoc({ brands, subtypes, materials, productCount }: FilterDrawerNuocProps) {
        ...
        <>
            ...
            >
                ...
                <div className="flex-1 overflow-y-auto px-5 py-6">
                    <SmartFilterNuoc brands={brands} subtypes={subtypes} materials={materials} />
                </div>
