...
import { createBepProduct, updateBepProduct } from '@/lib/bep-actions'
...
interface ProductType { id: number; name: string; slug: string; bep_subtypes: LookupItem[] }

interface BepProductFormProps {
    product?: any
...
export function BepProductForm({
    product,
    productTypes,
    brands,
    colors,
    ...
    const [uploadedImages, setUploadedImages] = useState<string[]>(() => {
        ...
        if (product?.bep_product_images) {
            product.bep_product_images.forEach((img: any) => {
    ...
    const filteredSubtypes = form.product_type_id
        ? productTypes.find((pt) => pt.id.toString() === form.product_type_id)?.bep_subtypes || []
        : []
        ...
        <form onSubmit={onSubmit} className="space-y-8">
            ...
            <div className="bg-white rounded-2xl border border-[#E4EEF2] p-6 space-y-5">
                ...
                <div>
                    ...
                    <p className="mt-1 text-xs text-muted-foreground">
                        URL: /thiet-bi-bep/[loai]/<span className="font-mono text-primary">{form.slug || 'slug'}</span>
                    </p>
                </div>
            </div>
            ...
            <div className="bg-white rounded-2xl border border-[#E4EEF2] p-6 space-y-5">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
                    ...
                    <div>
                        <label className={labelCls}>Phân loại con</label>
                        <select
                            className={selectCls}
            ...
            <div className="bg-white rounded-2xl border border-[#E4EEF2] p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        placeholder="Các tính năng nổi bật (mỗi dòng 1 tính năng)..."
                    />
                </div>
            </div>
