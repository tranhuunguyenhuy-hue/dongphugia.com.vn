-- LEO-538 reduced-runtime schema.
-- The canonical PostgreSQL Baseline v1 and MS885 Family migration are replayed
-- into the private dpg_app schema. Data loading is performed only by the
-- manifest-driven LEO-538 exporter/restore procedure.
SET ROLE dpg_migration;
SET search_path = dpg_app, extensions, public;
...
CREATE TABLE "blog_posts" (
    ...
    "author_name" VARCHAR(100) NOT NULL DEFAULT 'Ban Biên Tập Đông Phú Gia',
    "author_avatar" TEXT,
    "is_featured" BOOLEAN NOT NULL DEFAULT false,
    ...
    "schedule_blocked_code" VARCHAR(100),
    "schedule_blocked_at" TIMESTAMPTZ(6),
    "schedule_last_attempt_at" TIMESTAMPTZ(6),
...
CREATE TABLE "publishing_machine_identities" (
    ...
    CONSTRAINT "publishing_machine_identities_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "publishing_identity_capabilities" (
    ...
    CONSTRAINT "publishing_identity_capabilities_pkey" PRIMARY KEY ("identity_id","capability")
);
...
CREATE TABLE "publishing_identity_ip_allowlist" (
    ...
    CONSTRAINT "publishing_identity_ip_allowlist_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "publishing_managed_media" (
    ...
    CONSTRAINT "publishing_managed_media_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "publishing_blog_post_media" (
    ...
    CONSTRAINT "publishing_blog_post_media_pkey" PRIMARY KEY ("post_id","media_id","usage")
);
...
CREATE TABLE "publishing_rate_limit_windows" (
    ...
    CONSTRAINT "publishing_rate_limit_windows_pkey" PRIMARY KEY ("identity_id","bucket","window_start")
);
...
CREATE TABLE "publishing_global_controls" (
    ...
    CONSTRAINT "publishing_global_controls_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "publishing_scheduler_state" (
    ...
    CONSTRAINT "publishing_scheduler_state_pkey" PRIMARY KEY ("id")
);
...
CREATE TABLE "publishing_audit_events" (
    ...
    CONSTRAINT "publishing_audit_events_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE INDEX "idx_blog_posts_publishing_list" ON "blog_posts"("publishing_identity_id", "updated_at" DESC, "id" DESC);

-- CreateIndex
CREATE INDEX "idx_blog_posts_publishing_status" ON "blog_posts"("publishing_identity_id", "status", "updated_at" DESC, "id" DESC);

-- CreateIndex
CREATE INDEX "idx_blog_posts_scheduler" ON "blog_posts"("status", "scheduled_for", "id");

-- CreateIndex
CREATE UNIQUE INDEX "uq_blog_posts_publishing_external" ON "blog_posts"("publishing_identity_id", "external_id");

-- CreateIndex
CREATE UNIQUE INDEX "blog_tags_slug_key" ON "blog_tags"("slug");

-- CreateIndex
CREATE INDEX "idx_blog_tags_active_name" ON "blog_tags"("is_active", "name");
...
-- CreateIndex
CREATE UNIQUE INDEX "publishing_machine_identities_name_key" ON "publishing_machine_identities"("name");

-- CreateIndex
CREATE INDEX "idx_publishing_identities_sponsor" ON "publishing_machine_identities"("sponsor_user_id");

-- CreateIndex
CREATE INDEX "idx_publishing_identities_active" ON "publishing_machine_identities"("is_active");

-- CreateIndex
CREATE INDEX "idx_publishing_capabilities_active" ON "publishing_identity_capabilities"("capability", "revoked_at");

-- CreateIndex
CREATE UNIQUE INDEX "publishing_credentials_token_hash_key" ON "publishing_credentials"("token_hash");

-- CreateIndex
CREATE INDEX "idx_publishing_credentials_identity" ON "publishing_credentials"("identity_id", "environment", "expires_at");

-- CreateIndex
CREATE INDEX "idx_publishing_credentials_expiry" ON "publishing_credentials"("expires_at", "revoked_at");

-- CreateIndex
CREATE UNIQUE INDEX "uq_publishing_identity_ip" ON "publishing_identity_ip_allowlist"("identity_id", "ip_address");

-- CreateIndex
CREATE UNIQUE INDEX "publishing_managed_media_storage_path_key" ON "publishing_managed_media"("storage_path");

-- CreateIndex
CREATE UNIQUE INDEX "publishing_managed_media_primary_url_key" ON "publishing_managed_media"("primary_url");

-- CreateIndex
CREATE INDEX "idx_publishing_media_identity_status" ON "publishing_managed_media"("identity_id", "status");

-- CreateIndex
CREATE INDEX "idx_publishing_media_created" ON "publishing_managed_media"("created_at");

-- CreateIndex
CREATE INDEX "idx_publishing_post_media_asset" ON "publishing_blog_post_media"("media_id");

-- CreateIndex
CREATE INDEX "idx_publishing_post_media_usage" ON "publishing_blog_post_media"("post_id", "usage");

-- CreateIndex
CREATE INDEX "idx_publishing_idempotency_expiry" ON "publishing_idempotency_records"("expires_at");

-- CreateIndex
CREATE INDEX "idx_publishing_idempotency_resource" ON "publishing_idempotency_records"("resource_type", "resource_id");

-- CreateIndex
CREATE UNIQUE INDEX "uq_publishing_idempotency_identity_key" ON "publishing_idempotency_records"("identity_id", "key_hash");

-- CreateIndex
CREATE INDEX "idx_publishing_rate_window_cleanup" ON "publishing_rate_limit_windows"("window_start");

-- CreateIndex
CREATE INDEX "idx_publishing_audit_created" ON "publishing_audit_events"("created_at" DESC);

-- CreateIndex
CREATE INDEX "idx_publishing_audit_identity" ON "publishing_audit_events"("identity_id", "created_at" DESC);

-- CreateIndex
CREATE INDEX "idx_publishing_audit_post" ON "publishing_audit_events"("post_id", "created_at" DESC);

-- CreateIndex
CREATE INDEX "idx_publishing_audit_request" ON "publishing_audit_events"("request_id");
...
-- AddForeignKey
ALTER TABLE "blog_posts" ADD CONSTRAINT "blog_posts_publishing_identity_id_fkey" FOREIGN KEY ("publishing_identity_id") REFERENCES "publishing_machine_identities"("id") ON DELETE RESTRICT ON UPDATE NO ACTION;
...
-- AddForeignKey
ALTER TABLE "publishing_machine_identities" ADD CONSTRAINT "publishing_machine_identities_sponsor_user_id_fkey" FOREIGN KEY ("sponsor_user_id") REFERENCES "admin_users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_identity_capabilities" ADD CONSTRAINT "publishing_identity_capabilities_identity_id_fkey" FOREIGN KEY ("identity_id") REFERENCES "publishing_machine_identities"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_credentials" ADD CONSTRAINT "publishing_credentials_identity_id_fkey" FOREIGN KEY ("identity_id") REFERENCES "publishing_machine_identities"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_credentials" ADD CONSTRAINT "publishing_credentials_rotated_from_credential_id_fkey" FOREIGN KEY ("rotated_from_credential_id") REFERENCES "publishing_credentials"("id") ON DELETE SET NULL ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_identity_ip_allowlist" ADD CONSTRAINT "publishing_identity_ip_allowlist_identity_id_fkey" FOREIGN KEY ("identity_id") REFERENCES "publishing_machine_identities"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_managed_media" ADD CONSTRAINT "publishing_managed_media_identity_id_fkey" FOREIGN KEY ("identity_id") REFERENCES "publishing_machine_identities"("id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_blog_post_media" ADD CONSTRAINT "publishing_blog_post_media_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "blog_posts"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_blog_post_media" ADD CONSTRAINT "publishing_blog_post_media_media_id_fkey" FOREIGN KEY ("media_id") REFERENCES "publishing_managed_media"("id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_idempotency_records" ADD CONSTRAINT "publishing_idempotency_records_identity_id_fkey" FOREIGN KEY ("identity_id") REFERENCES "publishing_machine_identities"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_rate_limit_windows" ADD CONSTRAINT "publishing_rate_limit_windows_identity_id_fkey" FOREIGN KEY ("identity_id") REFERENCES "publishing_machine_identities"("id") ON DELETE CASCADE ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_audit_events" ADD CONSTRAINT "publishing_audit_events_identity_id_fkey" FOREIGN KEY ("identity_id") REFERENCES "publishing_machine_identities"("id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_audit_events" ADD CONSTRAINT "publishing_audit_events_admin_actor_id_fkey" FOREIGN KEY ("admin_actor_id") REFERENCES "admin_users"("id") ON DELETE RESTRICT ON UPDATE NO ACTION;

-- AddForeignKey
ALTER TABLE "publishing_audit_events" ADD CONSTRAINT "publishing_audit_events_post_id_fkey" FOREIGN KEY ("post_id") REFERENCES "blog_posts"("id") ON DELETE RESTRICT ON UPDATE NO ACTION;
