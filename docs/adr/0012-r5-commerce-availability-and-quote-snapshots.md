...
R5 replaces the earlier two-value Availability vocabulary in ADR 0001, **Keep
the Product SEO contract simple and delete discontinued products**, with the
...
The older Availability wording in ADR 0001, **Keep the Product SEO contract
simple and delete discontinued products**, is superseded for R5 commerce
