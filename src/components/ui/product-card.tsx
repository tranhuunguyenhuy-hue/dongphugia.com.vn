...
export function ProductCard({ product, showPrice = true, patternSlug, basePath = '/gach-op-lat', ...props }: ProductCardProps) {
    ...
    const statusLabel =
        ...
        'Đang bán';
    const canShowPrice = showPrice && priceState === 'priced' && salePrice;
        ...
        <Link href={resolvedHref} className="group flex flex-col w-full h-full transition-all duration-300 relative">
            ...
            <div className={cn(
                ...
                {(discountPercent > 0 || product.is_promotion) && (
                    <div className="absolute top-4 left-0 z-20">
                        <div className="bg-[#C62828] text-white font-bold text-[11px] px-2.5 py-[3px] rounded-r-md shadow-md flex items-center shadow-red-900/20 tracking-wider">
            ...
            <div className="flex flex-col pt-3 pb-1 w-full flex-grow">
                ...
                <div className="flex items-center justify-between mb-1 min-h-[16px]">
                    <span className="text-[10px] font-semibold text-neutral-600 truncate pr-2 uppercase tracking-widest flex-1">
                        ...
                        <div className="flex items-center gap-1.5 text-[10px] text-neutral-600 shrink-0">
                            {saleStatus && (
                                <span className={cn(
                                    ...
                                    saleStatus === 'discontinued' ? "bg-red-500" :
