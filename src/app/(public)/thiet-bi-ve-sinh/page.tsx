...
import { getTBVSTypes, getTBVSProducts, getTBVSFilterData } from "@/lib/public-api-tbvs"
...
export default async function ThietBiVeSinhPage({ searchParams }: PageProps) {
    ...
    const [typesData, productsData, filterData] = await Promise.all([
        getTBVSTypes(),
        getTBVSProducts(filters),
        getTBVSFilterData(activeTypeSlug),
    ])
    ...
    const subtypesForFilter = uniqueBySlug(filterData.subtypes)
    const mappedBrands = uniqueBySlug(filterData.brands)
                ...
                <div className="flex flex-col lg:flex-row gap-10 lg:gap-[64px]">
                    ...
                    <div className="flex-1 flex flex-col gap-[32px] min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-[13px]">
                            ...
                            <span className="text-neutral-900 font-medium">Thiết bị vệ sinh</span>
                        </div>
                        ...
                        <div className="flex flex-col gap-6 mt-2">
                            <div className="flex items-end justify-between border-b border-neutral-100 pb-4">
                                <h1 className="text-[28px] font-semibold text-neutral-900 tracking-tight leading-none">
                                    {activeType ? activeType.name : "Thiết bị vệ sinh"}
                                </h1>
