...
interface BepType { id: number; name: string; slug: string }
interface CategorySelectorBepProps { types: BepType[] }

export function CategorySelectorBep({ types }: CategorySelectorBepProps) {
