...
// Generated by:
// - scripts/db/export-product-redirect-map.mts
// - taxonomy/cross-root redirect artifact
import redirectData from "@/data/product-redirect-map.json";
import taxonomyRedirectData from "@/data/catalog-taxonomy-v2-redirect-map.json";

const redirectMap = new Map<string, string>([
  ...Object.entries(redirectData),
  ...Object.entries(taxonomyRedirectData),
]);
