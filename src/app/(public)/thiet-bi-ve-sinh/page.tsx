...
import { getTBVSTypes, getTBVSProducts } from "@/lib/public-api-tbvs"
import prisma from "@/lib/prisma"
import { SmartFilterTBVS } from "@/components/category/smart-filter-tbvs"
import { ProductCard } from "@/components/ui/product-card"
import { CategorySelectorTBVS } from "@/components/category/category-selector-tbvs"
import { BrandCarouselTBVS } from "@/components/category/brand-carousel-tbvs"
import { FilterDrawerTBVS } from "@/components/category/filter-drawer-tbvs"

export const revalidate = 3600

export const metadata: Metadata = {
    title: "Thiết bị vệ sinh cao cấp",
    description: "Khám phá danh mục thiết bị vệ sinh cao cấp: Bồn cầu, Chậu rửa, Sen vòi, Bồn tắm — chính hãng, giá tốt tại Đông Phú Gia Đà Lạt.",
    keywords: ["thiết bị vệ sinh", "bồn cầu", "chậu rửa", "sen vòi", "bồn tắm", "Đà Lạt"],
    openGraph: {
        title: "Thiết bị vệ sinh cao cấp | Đông Phú Gia",
        description: "Danh mục thiết bị vệ sinh cao cấp: Bồn cầu, Chậu rửa, Sen vòi — chính hãng tại Đà Lạt.",
        url: "/thiet-bi-ve-sinh",
        images: [
            {
                url: "/images/categories/thiet-bi-ve-sinh.png",
                width: 1200,
                height: 630,
                alt: "Thiết bị vệ sinh cao cấp - Đông Phú Gia",
            },
        ],
    },
}
...
async function getBrandsForCarousel(typeSlug?: string) {
    return prisma.tbvs_brands.findMany({
        where: { is_active: true },
        include: { _count: { select: { tbvs_products: { where: { is_active: true } } } } },
                ...
                <div className="flex flex-col lg:flex-row gap-[51px]">
                    ...
                    <div className="flex-1 flex flex-col gap-[40px] min-w-0">
                        ...
                        <div className="flex items-center gap-2 text-[14px]">
                            ...
                            <span className="text-[#15803d] font-semibold">Thiết bị vệ sinh</span>
                        </div>
                        ...
                        <Suspense fallback={null}>
                            <CategorySelectorTBVS types={typesData} />
                        </Suspense>
                        ...
                        <div className="flex flex-col gap-6">
                            <div className="flex items-center justify-between">
                                <h2 className="text-[24px] font-semibold text-[#111827] tracking-[-0.48px] leading-[32px]">
                                    ...
                                    {activeType ? activeType.name.toLowerCase() : "thiết bị vệ sinh"}
                                </h2>
