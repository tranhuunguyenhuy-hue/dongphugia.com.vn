 ...
 *
 * Contains all interactive form state, submission logic, and contact info display.
 * Separated from lien-he/page.tsx (Server Component) to allow metadata export.
 */
                                ...
                                <div className="flex items-start gap-4">
                                    ...
                                    <div className="flex flex-col pt-1 gap-1">
                                        <div>
                                            ...
                                            <a href={`tel:${siteConfig.contact.hotline}`} className="text-base text-neutral-900 font-bold hover:text-[#2E7A96] transition-colors">
                                ...
                                <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div className="flex flex-col gap-2.5">
                                            <label htmlFor="contact-name" className="text-sm font-medium text-neutral-700">Họ và tên <span className="text-red-500">*</span></label>
                                            <Input
                                                id="contact-name"
                                                name="name"
                                        ...
                                        <div className="flex flex-col gap-2.5">
                                            <label htmlFor="contact-phone" className="text-sm font-medium text-neutral-700">Số điện thoại <span className="text-red-500">*</span></label>
                                            <Input
                                                id="contact-phone"
                                                name="phone"
                                                type="tel"
                                    ...
                                    <div className="flex flex-col gap-2.5">
                                        <label htmlFor="contact-message" className="text-sm font-medium text-neutral-700">Nội dung tư vấn <span className="text-red-500">*</span></label>
                                        <Textarea
                                            id="contact-message"
                                            name="message"
