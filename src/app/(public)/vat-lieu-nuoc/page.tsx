...
export const metadata: Metadata = {
    ...
    description: "Vật liệu nước chính hãng tại Đông Phú Gia Đà Lạt. Đường ống, phụ kiện nước, van, khớp nối cao cấp.",
    keywords: ["vật liệu nước", "đường ống", "phụ kiện nước", "van nước", "Đà Lạt"],
}
