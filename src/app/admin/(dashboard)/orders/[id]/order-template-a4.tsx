        ...
        return (
            <div className="w-[210mm] min-h-[297mm] bg-white p-[20mm] mx-auto text-[14px] text-black shadow-lg" ref={ref}>
                ...
                <div className="text-center mb-8">
                    <h2 className="text-2xl font-bold uppercase">Bảng Báo Giá / Đơn Hàng</h2>
                ...
                <div className="mb-6 grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p><strong>Mã đơn hàng:</strong> {data.order_number}</p>
                    </div>
                </div>
                            ...
                            return (
                                <tr key={item.id} style={{ pageBreakInside: 'avoid' }}>
                                    ...
                                    <td className="border border-black p-2">
                                        ...
                                        {item.product_sku && item.product_sku !== 'N/A' && <div className="text-xs text-gray-500">Mã: {item.product_sku}</div>}
                                    </td>
...
OrderTemplateA4.displayName = 'OrderTemplateA4'
